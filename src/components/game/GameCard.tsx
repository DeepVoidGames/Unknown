...
import { Sparkles, Zap, Star, Circle, Coins, Trophy, RefreshCw } from 'lucide-react';
...
const typeIcons: Record<string, any> = {
  COMMON: Circle,
  NORMAL: Circle, // Support for old data
  RARE: Star,
  HOLO: Sparkles,
  FULL_ART: Zap,
  SILVER: Coins,
...
const rarityConfig: Record<string, any> = {
  ...
  NORMAL: { border: 'border-border', bg: 'bg-card' }, // Support for old data
...
export function GameCard({ card, onClick, isActive }: GameCardProps) {
  ...
  // Choose primary border based on "highest" type
